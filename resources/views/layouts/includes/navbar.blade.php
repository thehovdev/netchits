    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-netchits">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a class="pointer" href="/user/{{ $user->id }}" target="_blank"><img src="/storage/user-profile-images/{{ $user->image_id }}" class="img-circle" width="30px" height="30px"/></a></li>
                <li><a class="pointer" href="/user/{{ $user->id }}" target="_blank"><span>{{ $user->email}}</span></a></li>
